  ...
  return (
    <div className={darkMode=="dark" ? "dark" : "light"}>
      <div className="grid grid-cols-5 h-screen text-center">
        <select onChange={(e)=>setDarkMode(e.target.value)} className="fixed dark:text-white text-zinc-800 bottom-0 p-5 dark:bg-stone-950 bg-zinc-200">
        ...
        <div className="col-span-4 p-10">
          ...
          <div className="dark:bg-zinc-800 bg-red-100 w-1/2 dark:text-white text-zinc-800 m-auto rounded-4xl border border-zinc-700 flex h-16 p-1 pr-5">
            <input
              type="text"
              onKeyDown={isEnter}
              value={question}
