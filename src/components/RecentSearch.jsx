          ...
          {recentHistory &&
            recentHistory.map((item,i) => (
              <div className="flex justify-between pr-3 py-1">
                ...
                className="pl-5 w-full px-5 truncate dark:text-zinc-400 text-zinc-700 cursor-pointer dark:hover:bg-zinc-700 dark:hover:text-zinc-200 hover:bg-red-200 hover:text-zinc-800"
              >
                {item}
                
              </li>
              <button onClick={()=>clearSelectedHistory(item)} className="cursor-pointer hover:bg-zinc-900 bg-zinc-700 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="20px"
              viewBox="0 -960 960 960"
